import SendConsoleLog1 from "../costumer/handler/send-console-log1.handler";
import SendConsoleLog2 from "../costumer/handler/send-console-log2.handler";
import SendEmailWhenProductIsCreatedHander from "../product/handler/send-email-when-product-is-created.handler";
import ProductCreatedEvent from "../product/product-created-event";
import CostumerCreatedEvent from "../costumer/costumer-created-events";
